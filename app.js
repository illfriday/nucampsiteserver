...
//handle PROMISE returned from .connect() METHOD. Handling the ERROR w/o .catch() METHOD bc we aren't chaining METHOD(simple RETURN STATEMENT)
connect.then(
...
var app = express();
//re-route all requests through the HTTPS SECURE SERVER
